...
hl.on("hyprland.start", function ()
	...
	hl.exec_cmd("awww img ~/Downloads/arch_logo_wallpaper.png")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(33ccffee)", "rgba(3d59a1ee)"}, angle = 45 },
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.6, bezier = "almostLinear"})
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 1.6, bezier = "almostLinear"})
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("amixer -q sset Master 5+"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("amixer -q sset Master 5-"),      { locked = true, repeating = true })
